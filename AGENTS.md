...
Task completion requires implementation, executable validation code, automated checks, a user-run scenario, and recorded evidence. Do not unlock a dependent task while any of these gates is missing.
