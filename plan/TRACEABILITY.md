...
| Shortcut customization | 5 | LRH-013 | tray `Configure hotkeys...` opens native capture UI in `src/windows/settings.rs`; collision-checked registry persistence and live notification refresh implemented; capture/keycap tests and 29-test suite pass; user capture/restart/ready-check action evidence remains |
