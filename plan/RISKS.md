...
| Hook optimization changes matching or input pass-through | Medium | High | Binding-equivalence tests, callback timing, high-rate input tests, and real ready-check cleanup evidence | Windows integration | Planned LRH-019 |
