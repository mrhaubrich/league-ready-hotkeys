...
use windows::Win32::UI::WindowsAndMessaging::{AppendMenuW, CreatePopupMenu, DestroyIcon, DestroyMenu, GetCursorPos, HICON, LoadImageW, SetForegroundWindow, TrackPopupMenu, IMAGE_ICON, LR_DEFAULTSIZE, LR_LOADFROMFILE, MF_STRING, TPM_RIGHTBUTTON, WM_USER};
...
impl TrayIcon {
    ...
    pub fn add(&mut self) -> bool {
        ...
        unsafe { let _ = Shell_NotifyIconW(NIM_DELETE, &self.data); }
    ...
    pub fn show_menu(&self) -> bool {
        ...
        unsafe { let _ = AppendMenuW(menu, MF_STRING, MENU_EXIT as usize, windows::core::w!("Exit")); }
        let mut point = windows::Win32::Foundation::POINT::default();
        unsafe { let _ = GetCursorPos(&mut point); let _ = SetForegroundWindow(self.data.hWnd); }
        let _ = unsafe { TrackPopupMenu(menu, TPM_RIGHTBUTTON, point.x, point.y, 0, self.data.hWnd, None) };
